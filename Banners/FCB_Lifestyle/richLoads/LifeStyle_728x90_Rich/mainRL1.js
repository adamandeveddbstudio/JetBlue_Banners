...
function animate() {
  ...
  tl.addLabel('frame1', 0)
    .to('#copy1', 0.5, { autoAlpha: 1,y:-18, ease: Power1.easeInOut }, 'frame1+=0.5')
  ...
  tl.addLabel('frame2', 2.5)
    ...
    .to('#copy2', 0.5, { autoAlpha: 1,y:-18, ease: Power1.easeInOut }, 'frame2+=1.5')


  tl.addLabel('frame3', 5.5)
    .to('#RightSide', 0.5, { autoAlpha: 0, ease: Power1.easeInOut }, 'frame3+=0.5')
    .to('#frame3', 1, { x:-464,autoAlpha:1, ease: Power1.easeInOut }, 'frame3+=0.5')
    .to('#shine1', 1, { autoAlpha: 1, x:183,y:0 }, 'frame3+=1.5');
