...
function animate() {
  ...
  tl.addLabel('frame2', 2.5)
    ...
    .to('#copy2', 0.5, { autoAlpha: 1,y:-18, ease: Power1.easeInOut }, 'frame2+=0.5')


  tl.addLabel('frame3', 4.5)
    .to('#frame3', 1, { y:-585, ease: Power1.easeInOut }, 'frame3+=0.5')
    .to('#shine1', 1, { autoAlpha: 1, x:428,y:-119 }, 'frame3+=1.5');
