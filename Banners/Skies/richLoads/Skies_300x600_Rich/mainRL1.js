...
function animate() {
  ...
  tl.addLabel('frame2', 0.5)
    .to('#copy2', 0.5, { autoAlpha: 1,y:87, ease: Power1.easeOutIn }, 'frame2+=0.5')
  ...
  tl.addLabel('frame4', 7)
    .to('#frame4', 1, { y:-585, ease: Power1.easeInOut }, 'frame4+=0.5')
    .to('#shine1', 1, { autoAlpha: 1, x:430,y:0 }, 'frame4+=1.5');
